MRSortLPD <- function(inputs)
{
  ...
  assignments <- LPDMRSort(performanceTable = inputs$performanceTable,
                           categoriesLowerProfiles = inputs$categoriesLowerProfiles,
                           categoriesRanks = inputs$categoriesRanks,
                           criteriaWeights = inputs$criteriaWeights,
                           criteriaMinMax = inputs$criteriaMinMax,
                           majorityThreshold = inputs$majorityThreshold,
                           criteriaVetos = inputs$criteriaVetos,
                           criteriaDictators = inputs$criteriaDictators,
                           majorityRule = inputs$majorityRule,
                           alternativesIDs = inputs$alternativesIDs,
                           criteriaIDs = inputs$criteriaIDs,
                           categoriesIDs  = inputs$categoriesIDs)
